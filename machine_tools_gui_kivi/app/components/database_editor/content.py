...
from machine_tools_gui_kivi.app.components.database_editor.right_column import RightColumn
...
class TemplateDatabaseEditor(BoxLayout):
    ...
    def __init__(
        ...
        screen_manager=None,
        debug_mode=False,
        on_technical_requirements_change=None,
        on_technical_requirement_name_change=None,
        **kwargs,
    ):
