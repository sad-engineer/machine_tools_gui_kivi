...
class PropertyRow(BoxLayout):
    ...
    def __init__(self, property_name, on_value_change=None, on_name_change=None, **kwargs):
        super().__init__(orientation="horizontal", size_hint=(1, None), height=30, spacing=2, **kwargs)
...
class RightColumn(BoxLayout):
    ...
    def __init__(self, debug_mode=False, on_property_change=None, on_property_name_change=None, **kwargs):
        super().__init__(orientation="vertical", size_hint=(1, 1), spacing=2, padding=[2, 2, 2, 2], **kwargs)
    ...
    def get_all_properties(self):
        ...
        """
        return {name: row.get_value() for name, row in self._property_rows.items()}
...
if __name__ == "__main__":
    ...
    class TestRightColumnApp(App):
        def build(self):
            ...
            right_column = RightColumn(size_hint=(1, 1), pos_hint={"top": 1}, debug_mode=True)
